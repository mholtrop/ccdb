...
#pragma region Setters and getters
    ...
    std::shared_ptr<Directory> ConstantsTypeTable::GetDirectory() const
    {
        return mDirectory;
    }
    ...
    void ConstantsTypeTable::SetDirectory(std::shared_ptr<Directory> fDirectory)
    {
    ...
    std::map<string, ConstantsTypeColumn> &ConstantsTypeTable::GetColumnsByName()
    {
