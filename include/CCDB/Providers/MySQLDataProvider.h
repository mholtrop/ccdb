...
#pragma region Direcotry management
        ...
        */
        virtual shared_ptr<Directory> GetDirectory(const string &path);
...
#pragma region Constant type table
        ...
        GetConstantsTypeTable(const string &name, std::shared_ptr<Directory> parentDir, bool loadColumns = false);
         ...
         * @return   DVariation*
         */
        virtual std::shared_ptr<Variation> GetVariation(const string &name);
    ...
    private:
        ...
        * @return   DVariation*
        */
        virtual shared_ptr<Variation> GetVariationById(int id);
    ...
    protected:
        ...
        void EnsureVariationsLoaded() override;
...
#pragma region MySQL specific
        ...
        { return false; } //TODO implement PreparedStatements for GetAssignmentShort funcitons
...
#pragma region Debug and optimization
        ...
        string LastFullQuerry() const
        { return mLastFullQuerry; }

        string LastShortQuerry() const
        { return mLastShortQuerry; }
