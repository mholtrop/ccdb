...
namespace ccdb
{
    ...
    public:
        ...
        SQLiteDataProvider(const SQLiteDataProvider &o) = default;

        SQLiteDataProvider(SQLiteDataProvider &&o) = default;

        SQLiteDataProvider &operator=(const SQLiteDataProvider &other) = delete;

        SQLiteDataProvider &operator=(SQLiteDataProvider &&other) = delete;
        ...
        */
        virtual std::shared_ptr<Directory> GetDirectory(const string &path);
        ...
        { return DataProvider::GetRootDirectory(); }
         ...
         */
        virtual bool
        SearchDirectories(vector<std::shared_ptr<Directory>> &resultDirectories, const string &searchPattern,
                          const string &parentPath = "", int take = 0, int startWith = 0);
         ...
         * @return list of
         */
        virtual vector<std::shared_ptr<Directory>>
        SearchDirectories(const string &searchPattern, const string &parentPath = "", int take = 0, int startWith = 0);
         ...
         * @return   bool
         */
        bool GetCheckDirectoriesUpdate() const
         ...
         * @return   void
         */
        void SetCheckDirectoriesUpdate(bool val)
        { mNeedCheckDirectoriesUpdate = val; }
         ...
         */
        ConstantsTypeTable GetConstantsTypeTable(const string &path, bool loadColumns) override;
         ...
         * @return new object of ConstantsTypeTable
         */
        ConstantsTypeTable GetConstantsTypeTable(const string &name, std::shared_ptr<Directory> parentDir, bool loadColumns) override;

        /// Get all table types from DB
        /// @param loadColumns: if true - load columns from DB
        std::vector<ConstantsTypeTable> GetAllTypeTables(bool loadColumns) override;
         ...
         * @return   DVariation*
         */
        virtual shared_ptr<Variation> GetVariation(const string &name);
    ...
    protected:
        ...
        virtual void EnsureVariationsLoaded();
    ...
    public:
         ...
         */
        virtual Assignment *
        GetAssignmentShort(int run, const string &path, const string &variation = "default", bool loadColumns = false);
        ...
        */
        virtual Assignment *
        GetAssignmentShort(int run, const string &path, time_t time, const string &variation = "default",
         ...
         */
        virtual Assignment *
        GetAssignmentFull(int run, const string &path, int version, const string &variation = "default");
         ...
         */
        virtual bool GetAssignments(vector<Assignment *> &assingments, const string &path, int runMin, int runMax,
                                    const string &runRangeName, const string &variation, time_t beginTime,
                                    time_t endTime, int sortBy = 0, int take = 0, int startWith = 0);
         ...
         */
        virtual bool
        GetAssignments(vector<Assignment *> &assingments, const string &path, int run, const string &variation = "",
                       time_t date = 0, int take = 0, int startWith = 0);
         ...
         * @return
         */
        virtual vector<Assignment *>
        GetAssignments(const string &path, int run, const string &variation = "", time_t date = 0, int take = 0,
                       int startWith = 0);
         ...
         * @return
         */
        virtual bool GetAssignments(vector<Assignment *> &assingments, const string &path, const string &runName,
                                    const string &variation = "", time_t date = 0, int take = 0, int startWith = 0);
         ...
         */
        virtual vector<Assignment *>
        GetAssignments(const string &path, const string &runName, const string &variation = "", time_t date = 0,
                       int take = 0, int startWith = 0);
    ...
    protected:
         ...
         * @return   void
         */
        void AddLogRecord(string userName, string affectedTables, string affectedIds, string shortDescription,
         ...
         */
        bool InitializePreparedStatements()
        { return false; } //TODO implement PreparedStatements for GetAssignmentShort functions

        //read of row fields
        bool
        IsNullOrUnreadable(int fieldNum);        ///Check if the field is NULL or is unreadable. If it is Unreadable
        ...
        void BuildDirectoryDependencies()
        { DataProvider::BuildDirectoryDependencies(); }            ///Builds directory relational structure. Used right at the end of RetriveDirectories().
        bool CheckDirectoryListActual()
        { return DataProvider::CheckDirectoryListActual(); }            ///Checks if directory list is actual i.e. nobody changed directories in database
        bool UpdateDirectoriesIfNeeded()
        { return DataProvider::UpdateDirectoriesIfNeeded(); }
