...
public:
    ...
    void			SetDirectory(std::shared_ptr<Directory> directory); 	 /// Parent directory	reference
    std::shared_ptr<Directory> 		GetDirectory() const;				 /// Parent directory	reference
...
private:
    ...
    std::shared_ptr<Directory>   mDirectory;		//Link to the directory that holds this constant
